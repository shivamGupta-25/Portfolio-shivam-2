...
export const DATA = {
  ...
  get workByCategory() {
    return [
      { heading: "Full-time", entries: this.data.fullTime },
      { heading: "Internships", entries: this.data.internships },
      { heading: "Freelance", entries: this.data.freelance },
