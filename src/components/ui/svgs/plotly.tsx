...
const Plotly = (props: SVGProps<SVGSVGElement>) => (
  <svg {...props} viewBox="0 0 64 64" fill="none">
    <rect x="12" y="36" width="6" height="18" rx="1" fill="#3F4F75" />
    <rect x="20" y="28" width="6" height="26" rx="1" fill="#3F4F75" />
    <rect x="28" y="16" width="6" height="38" rx="1" fill="#3F4F75" />
    <rect x="36" y="22" width="6" height="32" rx="1" fill="#3F4F75" />
    <rect x="44" y="32" width="6" height="22" rx="1" fill="#3F4F75" />
    <polyline
